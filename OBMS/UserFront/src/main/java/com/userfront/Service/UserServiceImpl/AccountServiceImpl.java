...
public class AccountServiceImpl implements AccountService {
	...
	public void deposit(String accountType, double amount, Principal principal) {
		...
		if (accountType.equalsIgnoreCase("Current")) {
			...
			currentAccountDao.save(currentAccount);
            Date date = new Date();
			CurrentTranscation currentTranscation = new CurrentTranscation(date, "Deposited to Current Account",
			...
			savingAccountDao.save(savingAccount);
			  Date date = new Date();
			SavingTranscation savingTransaction = new SavingTranscation(date, "Deposited to Saving Account", "Account",
					"Finished", amount, savingAccount.getAccountBalance(), savingAccount);
			transcationService.saveSavingDepositTranscation(savingTransaction);
		}
	}
	 ...
	 public void withdraw(String accountType, double amount, Principal principal) {
	        ...
	        if (accountType.equalsIgnoreCase("Current")) {
	            ...
	            transcationService.saveCurrentWithdrawTranscation(currentTranscation);
	           ...
	           transcationService.saveSavingWithdrawTranscation(savingTransaction);
	        }
	    }
